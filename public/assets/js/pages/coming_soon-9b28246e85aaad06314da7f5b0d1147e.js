...
$(document).ready(function() {
    if ($('#map').length) {
        ...
        /* Background Slide */
        $.backstretch([ "/assets/global/gallery/login4.jpg", "/assets/global/gallery/login3.jpg", "/assets/global/gallery/login2.jpg", "/assets/global/gallery/login.jpg"],{fade: 600, duration: 4000 
        });
    }
    map_height();
