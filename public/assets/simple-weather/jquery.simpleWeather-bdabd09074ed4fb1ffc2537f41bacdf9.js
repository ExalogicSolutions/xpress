...
(function($) {
  ...
  $.extend({
    simpleWeather: function(options){
      ...
      if(options.location !== '') {
        weatherUrl += 'select * from weather.forecast where woeid in (select woeid from geo.places where text="'+options.location+'" limit 1) and u="'+options.unit+'"';      } else if(options.woeid !== '') {
