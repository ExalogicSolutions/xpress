...
function validate_branch_head(){
  ...
  if(! isValidEmailAddress($("#email").val())){
    ...
    $(".email-error").text(I18n.t('js.email_error')).css("font-style", "italic");
...
function edit_industry(ele)
{
  var industryId = $(ele).attr("id");
  $.ajax({
    async : true,
    type : 'GET',
    url : "/industries/"+industryId+"/edit",   
    success : function(data) {
      $('#modal-responsive').html(data);
      $('#modal-responsive').modal('show');
    },
...
function delete_industry(ele)
{
  var industryId = $(ele).attr("id");
  $.ajax({
    async : true,
    type : 'GET',
    url : "/industries/get_industry",
    data: {"id": industryId},   
    success : function(data) {
...
// -------------------------BRANCH------------------------------------
function create_branch(ele)
{
  var industryId = $(ele).attr("industry_id");
  $.ajax({
    async : true,
    type : 'GET',
    url : "/branches/new",
